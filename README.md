...
Pull requests are so named  because you are requesting the target repository to grab (pull) your changes to the main repository. 
...
No it doesn't. I need to push it too.
